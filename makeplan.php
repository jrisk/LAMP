...
<div class='col-sm-6'>
<h2><input name='lesson-name' id='lessonname3' type='text' class='form-control'></h2>
</div>
</div>
</div>
...
<div class='col-sm-6'>
<h3><input name='user-group' type='text' class='form-control'></h3>
</div>
</div>
</div>
...
<button type="button" class="btn btn-primary btn-lg" id="updater2">Make New Plan</button>
</div>
</form>